...
////    BO.ProductItem item = bl.Product.GetProductManager(productId);
////    Console.WriteLine(item);
////}
...
////    BO.ProductItem item = bl.Product.GetProductCustomer(productId);
////    Console.WriteLine(item);
////}
...
////    bl.Cart.ConfirimCartToOrder(cart, CustomerName, CustomerEmail, CustomerAddress);
////}
////======================================Orders=====================================
...
//{
//    d.Order.Add(oo);
//    IEnumerable<Dal.DO.Order> orderList = d.Order.GetAll();
//    foreach (var item in orderList)
//    {
//        Console.WriteLine(item);
//    }
...
//   // Dal.DO.Order BoOrder = d.Order.Get(o => o  == orderId);
